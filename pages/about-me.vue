  ...
  <main v-if="!loading" id="about-me" class="page">
    ...
    <div id="page-menu" class="w-full flex">
      ...
      <div id="sections">
        <div
          id="section-icon"
          v-for="section in config.public.dev.about.sections"
          :key="section.title"
      ...
      >
        ...
        >
          ...
          />
          <p
            v-html="config.public.dev.about.sections[currentSection].title"
        ...
        <div>
          <div
            v-for="(folder, key, index) in config.public.dev.about.sections[
              currentSection
            ].info"
            :key="key"
        ...
        >
          ...
          />
          <p
            v-html="config.public.dev.contacts.direct.title"
            class="font-fira_regular text-white text-sm"
          ></p>
        </div>
        <div id="contact-sources" class="hidden lg:flex lg:flex-col my-2">
          <div
            v-for="(source, key) in config.public.dev.contacts.direct.sources"
            :key="key"
          ...
          >
            ...
            <div
              v-html="source"
              href="/"
              class="font-fira_retina text-menu-text hover:text-white text-ellipsis overflow-hidden"
            ></div>
          </div>
        </div>
      </div>
    ...
    <div class="flex flex-col lg:grid lg:grid-cols-2 h-full w-full">
      <div id="left" class="w-full flex flex-col border-right">
        ...
        <div id="tab-mobile" class="flex lg:hidden font-fira_retina">
          ...
          <h3
            v-html="
              config.public.dev.about.sections[currentSection].info[folder]
                .title
            "
...
export default {
  ...
  methods: {
    ...
    focusCurrentFolder(folder) {
      ...
      this.currentSection = this.config.public.dev.about.sections[
        this.currentSection
      ].info[folder.title]
        ? this.currentSection
        : Object.keys(this.config.public.dev.about.sections).find(
            (section) =>
              this.config.public.dev.about.sections[section].info[folder.title]
          );
    },
    /**
