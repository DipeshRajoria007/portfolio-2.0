  ...
  >
    ...
    <div class="w-full flex justify-between md:justify-start">
      ...
      <div id="social-icons" class="flex">
        ...
        <NuxtLink
          :to="social.leetcode.url + social.leetcode.user"
          target="_blank"
          class="flex justify-center items-center"
        >
        ...
        <NuxtLink
          :to="social.codeforces.url + social.codeforces.user"
          target="_blank"
          class="flex justify-center items-center"
        >
          <img src="/icons/social/codeforces.svg" />
        </NuxtLink>
      </div>
    </div>
    ...
    <NuxtLink
      :to="social.github.url + social.github.user"
      target="_blank"
      class="flex md:hidden items-center px-5 border-left"
    >
      @{{ social.github.user }}
      <img src="/icons/social/github.svg" />
    </NuxtLink> -->
